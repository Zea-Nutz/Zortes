...
if(usePairingCode && !rxhl.authState.creds.registered) {
		const phoneNumber = await question('mohon di masukin gan nomor bot lu supaya terhubung dengan Aga Bot di awali dengan Kode Negara:\n');
...
require("./comment")(rxhl, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
